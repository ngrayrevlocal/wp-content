				...
				<div class="col-md-6">
					...
					<ul id="menu-secondary-menu" class="secondary_menu ">
						<?php if( have_rows('nap_numbers', 'option') ):
							while ( have_rows('nap_numbers', 'option') ) : the_row(); ?>
								<li class="first">
									<a href="tel:<?php the_sub_field('number'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php the_sub_field('number_tooltip'); ?>" class="phone">
						...
						<li class="last">
							<?php if ( is_user_logged_in() ) { ?>
								<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('my account','woothemes'); ?>" class="account"><?php _e('my account','woothemes'); ?></a>
							<?php } 
							else { ?>
								<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('log in','woothemes'); ?>"class="account"><?php _e('log in','woothemes'); ?></a>
							<?php } ?>
						</li
>					</ul>
				</div><!-- .col-md-6 -->
